...
typedef struct mptcp_per_packet_data_t_ {
	...
	/* useful to track DSNs independantly of the subflow,
	 * for instance to compute inter packet arrival
	 */
	mptcp_dsn2packet_mapping_t *previous_packet_dsn;
